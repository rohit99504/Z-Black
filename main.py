...
bot = Client("bot",    
   bot_token="8018472448:AAFeeWtXPYg3vJ7bnTluBeqc05UT_0_CQLA",    
   api_id= 21179966,    
    ...
    try:    
        for i in range(count - 1, len(links)):
            ...
            if "visionias" in url:    
                ...
                tokencp ='eyJhbGciOiJIUzM4NCIsInR5cCI6IkpXVCJ9..vQR9sjTLUvXJn0FVIiJiRdfWwum0sgskxH9tKeEaTu-zzd8hhJ2F3Svo5YsnZQSG'
